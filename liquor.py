...
Original file is located at
    https://colab.research.google.com/drive/1rwcZd1pNx7qKmxVr-Y62qfXxkfISlKTo
"""
...
# Filter for WINE data
wine_data = monthly_sales[monthly_sales['ITEM TYPE'] == 'LIQUOR']
...
plt.title("Monthly LIQUOR Warehouse Sales")
plt.xlabel("Date")
plt.ylabel("Sales")
plt.grid(True)
plt.show()
...
plt.title('LIQUOR Sales Forecast + Reorder Alerts')
plt.xlabel('Date')
plt.ylabel('Sales')
plt.legend()
plt.grid(True)
...
xgb_predictions = xgb_model.predict(future_df)
...
plt.title('LIQUOR Forecast with ML Models')
plt.xlabel('Date')
plt.ylabel('Sales')
plt.legend()
plt.grid(True)
...
plt.title('LIQUOR Sales Forecast (SARIMA)')
plt.xlabel('Date')
plt.ylabel('Sales')
plt.legend()
plt.grid(True)
...
plt.title('LIQUOR Sales Forecast: Random Forest vs XGBoost (Next 12 Months)')
plt.xlabel('Date')
plt.ylabel('Sales')
plt.legend()
plt.grid(True)
